...
<body>
	...
	<center>
		...
		<legend align="center"><h1><b>Add Client</b></h1></legend>
		<table>
			<tr>
				<td>Username</td>
				<td><input type="text" onfocusout="checkUsername(this)" name="username" value="<?php echo $username;?>"><td><span id="err_username"><?php echo $err_username;?></span></td>
			</tr>
			<tr>
				<td>Password</td>
			...
			<tr>
				<td>Email</td>
				<td><input type="text" onfocusout="checkEmail(this)" name="email" value="<?php echo $email;?>"><td><span id="err_email"><?php echo $err_email;?></span></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Phone</td>
				<td><input type="text" name="phone" value="<?php echo $phone;?>"><td><span><?php echo $err_phone;?></span></td>
			</tr>
		</table>
