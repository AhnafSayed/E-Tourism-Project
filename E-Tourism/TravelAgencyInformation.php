	...
	<center>
		...
		<table border="2">
			...
			foreach ($travelagency as $t) {
				...
				echo "<td>".$t["Phone"]."</td>";
				echo "<td>".$t["ETIN"]."</td>";
				echo '<td><a href="UpdateTravelAgency.php?id='.$t["Id"].'"><input type="Submit" value="Update"></a></td>';
				echo '<td><a href = "DeleteTravelAgency.php?id='.$t["Id"].'"><input type="Submit" value="Delete"></a></td>';
